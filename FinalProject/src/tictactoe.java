...
public class tictactoe {
    ...
    public static void printout() { //print out the board
        ...
        for (int i = 0; i < board.length; i++) {
            System.out.println("-------------"); // print the horazontal lines
    ...
    public static boolean checkWin(char test){ // check if there is a win
        ...
        if (board[0][0] == test && board[1][1] == test && board[2][2] == test) { //check 1st diagonal
            return true;
        } else if (board[0][2] == test && board[1][1] == test && board[2][0] == test) { //check 2nd diagonal
            return true;
        }
        return false;
        ...
        while (run) {
          ...
          switch (selection){
            ...
            case "3": // if they entered 3, print the rules, wait for input, then go to the beginning
                ...
                System.out.println("The goal of the game is to get three in a row. The first player to achieve this wins.");
                System.out.println("The board is made up of 3 rows and 3 columns. The top left corner is 1,1 and the bottom right corner is 3,3.");
                System.out.println("To place your X, enter the row and column you want your X to go. For example, if you want to place your X in the middle, enter row 2 and coloum 2.");
                System.out.println("The computer will place O. ");
                System.out.println("If you have won, you will win 50 points. If you have lost, you will lose 50 points. If you have tied, your amount of points will not change.");
                System.out.println("If you want to play again, enter 1. If you want to exit, enter 2.");
